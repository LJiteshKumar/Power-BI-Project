# HR Dashboard – Presence, Working from Home (WFH) & Leave Tracking (Excel + Power BI)
...
- `dashboard-image` – (https://github.com/LJiteshKumar/Power-BI-Project/blob/main/Dashboard%20Screenshot.png)
